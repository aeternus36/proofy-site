...
(function(){
  ...
  QRCode.prototype = {
    ...
    _createCanvas:function(){
      ...
      // CRITICAL: lock CSS size to match backing store (prevents diagonal moiré)
      ...
      if (ctx && ctx.imageSmoothingEnabled !== undefined) ctx.imageSmoothingEnabled = false;

      // Fill background
      ctx.fillStyle = this._htOption.colorLight;
      ctx.fillRect(0,0,size,size);

      // Draw modules (pixel-perfect)
