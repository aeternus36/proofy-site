/*! qrcode.js (MIT) - Proofy build (pixel-perfect + quiet zone + optional fixed mask) */
(function(){
  ...
  function QRCode(el){
    ...
    this._htOption = {
      ...
      maskPattern: -1  // -1 = auto(best), 0..7 = force fixed mask
    };
  }
  ...
  QRCodeModel.prototype = {
    ...
    // NEW: allow forcing maskPattern (0..7). If invalid => auto(best)
    make:function(maskPattern){
      ...
      var forced = (typeof maskPattern === "number" && maskPattern>=0 && maskPattern<=7) ? maskPattern : -1;
      if(forced >= 0) this.makeImpl(false, forced);
      else this.makeImpl(false, this.getBestMaskPattern());
    },
  ...
  QRCode.prototype = {
    makeCode:function(text){
      ...
      // NEW: honor fixed mask if provided
      var mp = this._htOption.maskPattern;
      this._oQRCode.make(mp);
    ...
    _createCanvas:function(){
      ...
      // Choose integer scale to avoid moiré
