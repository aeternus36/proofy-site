/*! qrcode.js (MIT) - Proofy build (FIXED: valid encoding + pixel-perfect + quiet zone) */
(function(){
  ...
  // FIX: QRPolynomial must apply "shift" (append zeros) like the original library
  ...
  QRCodeModel.prototype = {
    ...
    make:function(){
      if(this.typeNumber < 1){
        ...
        // FIX: do NOT decrement! (this caused wrong version and invalid QR)
        if (this.typeNumber >= 40) this.typeNumber = 40;
      }
  ...
  // FIX: Correct createBytes (data + RS ecc + interleaving) like original qrcode.js
  ...
  QRCode.prototype = {
    ...
    _createCanvas:function(){
      ...
      // Hard force CSS size = intrinsic size (prevents any global canvas{width:100%} from breaking it)
