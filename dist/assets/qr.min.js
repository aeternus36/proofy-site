/*! qrcode.js (MIT) - Proofy build (pixel-perfect + quiet zone + HiDPI-safe) */
(function(){
  ...
  function QRCode(el){
    ...
    this._htOption = {
      ...
      minScale: 4      // minimum pixels per module (CSS px)
    };
  }
  ...
  QRCode.prototype = {
    ...
    _createCanvas:function(){
      ...
      // Choose integer scale (CSS px per module) to avoid moiré
      ...
      var size = count * scale; // CSS px

      // ✅ HiDPI-safe canvas: match backing store to device pixels
