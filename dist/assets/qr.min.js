/*! qrcode.js (MIT) - Proofy patch: integer cellSize + true quiet zone + prevent CSS scaling */
...
c.prototype={
  ...
  _createCanvas:function(){
    ...
    if(cellSize<2) cellSize=2; // prevent too-dense/too-thin modules
    ...
    // Critical: lock CSS size to pixel size (no resampling)
    canvas.style.width=size+"px";
    canvas.style.height=size+"px";
    canvas.style.maxWidth="100%";
    canvas.style.heightAuto="auto"; // harmless if ignored
