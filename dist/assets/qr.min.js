/*! qrcode.js (MIT) - fixed build for Proofy: RS/EC restored + auto typeNumber fixed + quiet zone in-canvas */
(function(){
...
getErrorCorrectPolynomial:function(errorCorrectLength){
  ...
  for(var i=0;i<errorCorrectLength;i++){
    // ✅ FIX: use gexp (not exp)
    a=a.multiply(new QRPolynomial([1,QRMathImpl.gexp(i)],0));
  }
  return a;
},
...
function QRCode(el){
  ...
  this._htOption = {
    ...
    height: 256,
    typeNumber: 0,
    margin: 4, // quiet zone (modules) inside canvas
    colorDark: "#000000",
    colorLight: "#ffffff",
